...
import { render, cleanup, waitForElement, fireEvent,getByTestId, prettyDOM, getByText, getByAltText, queryByAltText, queryByText, getAllByTestId, getByPlaceholderText } from "@testing-library/react";
...
describe("Application", () => {
  ...
  it("loads data, cancels an interview and increases the spots remaining for Monday by 1", async () => {
    ...
    expect(
      getByText(appointment, "Are you sure ? This action cannot be reversed")
    ).toBeInTheDocument();
  ...
  it("loads data, edits an interview and keeps the spots remaining for Monday the same", async () => {
    ...
    await waitForElement(() => getByText(appointment, "Hello world"));
    const day = getAllByTestId(container, "day").find((day) =>
      queryByText(day, "Monday")
    );
  ...
  it("shows the delete error when failing to delete an existing appointment", async () => {
    ...
    .find((appointment) => queryByText(appointment, "Archie Cohen"));
    fireEvent.click(queryByAltText(appointment, "Delete"));
    expect(getByText(appointment, "Are you sure ? This action cannot be reversed"))
    .toBeInTheDocument();
